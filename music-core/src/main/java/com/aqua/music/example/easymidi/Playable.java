...
public interface Playable {
	...
	public enum Action {
		...
		public void playAll(List<Playable>... playables) {
			for (List<Playable> eachGroup : playables) {
				for (Playable each : eachGroup) {
					this.action(each);
				}
			}
		}

		abstract void action(Playable playable);
	}
}
